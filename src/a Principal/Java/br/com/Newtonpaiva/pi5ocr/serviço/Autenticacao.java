...
import  br.com.newtonpaiva.pi5ocr.service.JwtTokenUtil;
...
try {
	...
	System.out.println("Não é possível obter o token");
} catch (ExpiredJwtException e) {
	System.out.println("Token está expirado");
}
} else {
	logger.warn("JWT Token é String");
}
